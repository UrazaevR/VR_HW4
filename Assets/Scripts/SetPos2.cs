...
public class SetPos2 : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        var resultFile = Path.Combine(Application.persistentDataPath, "result2.json");
        ...
        else
        {
            ...
            json_data = JsonUtility.FromJson<JsonClass>(File.ReadAllText(Application.persistentDataPath + "/result2.json"));
            move_obj();
